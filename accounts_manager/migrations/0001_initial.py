...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_manager_productionprofile', (
            ...
            ('bio', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('company_pic', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
    ...
    models = {
        ...
        u'accounts_manager.audition': {
            ...
            'males': ('django.db.models.fields.BinaryField', [], {}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'num_parts': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
        ...
        u'accounts_manager.productionprofile': {
            ...
            'bio': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
            'company_pic': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

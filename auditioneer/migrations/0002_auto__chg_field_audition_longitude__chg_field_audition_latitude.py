...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'auditioneer_audition', 'longitude', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=10))

        # Changing field 'Audition.latitude'
        db.alter_column(u'auditioneer_audition', 'latitude', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=10))

    def backwards(self, orm):

        # Changing field 'Audition.longitude'
        db.alter_column(u'auditioneer_audition', 'longitude', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Audition.latitude'
        db.alter_column(u'auditioneer_audition', 'latitude', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'auditioneer.audition': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'latitude': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '10'}),
